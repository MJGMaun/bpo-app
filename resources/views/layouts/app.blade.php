...
<html lang="{{ config('app.locale') }}" class="no-focus">
    <head>
        ...
        <title>BPO App - @yield('title')</title>
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            ...
                            <ul class="list-inline mt-5">
                                <li>
                                    <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href="javascript:void(0)">Hello, {{ auth::user()->first_name }}</a>
                                </li>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-visible">MGMT</span><span class="sidebar-mini-hidden">Management</span>
                            </li>
                            <li>
